...
if __name__ == "__main__":
    ...
    # dataset = load_dataset("json", data_files="/root/isc-demos/deepseek/cashq2.jsonl")
    dataset = load_dataset("json", data_files="/root/isc-demos/deepseek/cashq_part.jsonl")
    ...
    try:
        ...
        output_directory = os.environ.get("CHECKPOINT_ARTIFACT_PATH", "/root/isc-demos/llama2")
